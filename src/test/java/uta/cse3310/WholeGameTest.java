...
extends TestCase
{
    ...
    public void testGame()
    {
        ...
        message = "{\"button\":\"boardClick\",\"event\":\"gameEvent\",\"message\":\"f\",\"x\":\"8\",\"y\":\"0\"}";
        S = gson.fromJson(message, ServerEvent.class);
        S.player = player1;
        S.iidd = player1.iD;
        S.victores = Integer.toString(player1.numberOfVictores);
        ...
        message = "{\"button\":\"boardClick\",\"event\":\"gameEvent\",\"message\":\"e\",\"x\":\"13\",\"y\":\"0\"}";
        S = gson.fromJson(message, ServerEvent.class);
        S.player = player1;
        S.iidd = player1.iD;
        S.victores = Integer.toString(player1.numberOfVictores);
        ...
        //   S.victores = Integer.toString(player4.numberOfVictores);
          ...
          message = "{\"button\":\"backToLobbyButton\",\"event\":\"lobbyEvent\"}";
          S = gson.fromJson(message, ServerEvent.class);
          S.player = player4;
          S.iidd = player4.iD;
          S.victores = Integer.toString(player4.numberOfVictores);
        ...
        //   S.x = 33;
        //   S.y = 6;
          message = "{\"button\":\"boardClick\",\"event\":\"gameEvent\",\"message\":\"s\",\"x\":\"33\",\"y\":\"6\"}";
          S = gson.fromJson(message, ServerEvent.class);
          S.player = player2;
          S.iidd = player2.iD;
          S.victores = Integer.toString(player2.numberOfVictores);
        ...
        //   S.x = 33;
        //   S.y = 9;
          message = "{\"button\":\"boardClick\",\"event\":\"gameEvent\",\"message\":\"s\",\"x\":\"33\",\"y\":\"9\"}";
          S = gson.fromJson(message, ServerEvent.class);
          S.player = player2;
          S.iidd = player2.iD;
          S.victores = Integer.toString(player2.numberOfVictores);
        ...
        //   S.x = 0;
        //   S.y = 27;
        message = "{\"button\":\"boardClick\",\"event\":\"gameEvent\",\"message\":\"m\",\"x\":\"0\",\"y\":\"27\"}";
        S = gson.fromJson(message, ServerEvent.class);
        S.player = player1;
        S.iidd = player1.iD;
        S.victores = Integer.toString(player1.numberOfVictores);
        ...
        //   S.button = "boardClick";
        //   S.event = "gameEvent";
        //   S.message = "l"; //last letter clicked is l
        //   S.iidd = player1.iD;
        //   S.victores = Integer.toString(player1.numberOfVictores);
        //   S.x = 0;
        //   S.y = 21;
        message = "{\"button\":\"boardClick\",\"event\":\"gameEvent\",\"message\":\"l\",\"x\":\"0\",\"y\":\"21\"}";
        S = gson.fromJson(message, ServerEvent.class);
        S.player = player1;
        S.iidd = player1.iD;
        S.victores = Integer.toString(player1.numberOfVictores);
        ...
        S.victores = Integer.toString(player5.numberOfVictores);
          ...
          //Lets check if the horizontal word is correct in both rooms //future (8,0) (13,0)
          assertEquals("updateBoard", lobby.gameList.get(0).boardButtonMessage);
          assertEquals("vertical", lobby.gameList.get(0).checkOrientation(player1.x1, player1.y1, player1.x2, player1.y2));
          assertEquals("musical", lobby.gameList.get(0).selectWord(player1.x1, player1.y1, player1.x2, player1.y2));
          System.out.println("|||| VERTICAL UP WORD TEST: PASSED (ROOM 1)||||");

          assertEquals("updateBoard", lobby.gameList.get(1).boardButtonMessage);
          assertEquals("vertical", lobby.gameList.get(1).checkOrientation(player5.x1, player5.y1, player5.x2, player5.y2));
          assertEquals("musical", lobby.gameList.get(1).selectWord(player5.x1, player5.y1, player5.x2, player5.y2));
          System.out.println("|||| VERTICAL UP WORD TEST: PASSED (ROOM 2)||||");

        //   S = new ServerEvent("", "", null, 0, "", "", "");
        //   S.player = player1;
        //   S.button = "boardClick";
        //   S.event = "gameEvent";
        //   S.message = "o"; //first letter clicked is o
        //   S.iidd = player1.iD;
        //   S.victores = Integer.toString(player1.numberOfVictores);
        //   S.x = 15;
        //   S.y = 13;
        message = "{\"button\":\"boardClick\",\"event\":\"gameEvent\",\"message\":\"o\",\"x\":\"15\",\"y\":\"13\"}";
        S = gson.fromJson(message, ServerEvent.class);
        S.player = player1;
        S.iidd = player1.iD;
        S.victores = Integer.toString(player1.numberOfVictores);
        ...
        //   S.button = "boardClick";
        //   S.event = "gameEvent";
        //   S.message = "r"; //last letter clicked is r
        //   S.iidd = player1.iD;
        //   S.victores = Integer.toString(player1.numberOfVictores);
        //   S.x = 19;
        //   S.y = 9;
        message = "{\"button\":\"boardClick\",\"event\":\"gameEvent\",\"message\":\"r\",\"x\":\"19\",\"y\":\"9\"}";
        S = gson.fromJson(message, ServerEvent.class);
        S.player = player1;
        S.iidd = player1.iD;
        S.victores = Integer.toString(player1.numberOfVictores);
        ...
        S.victores = Integer.toString(player5.numberOfVictores);
          ...
          assertEquals("updateBoard", lobby.gameList.get(0).boardButtonMessage);
          assertEquals("diagonal", lobby.gameList.get(0).checkOrientation(player1.x1, player1.y1, player1.x2, player1.y2));
          assertEquals("oscar", lobby.gameList.get(0).selectWord(player1.x1, player1.y1, player1.x2, player1.y2));
          System.out.println("|||| DIAGONAL UP WORD TEST: PASSED (ROOM 1)||||");

          assertEquals("updateBoard", lobby.gameList.get(1).boardButtonMessage);
          assertEquals("diagonal", lobby.gameList.get(1).checkOrientation(player5.x1, player5.y1, player5.x2, player5.y2));
          assertEquals("oscar", lobby.gameList.get(1).selectWord(player5.x1, player5.y1, player5.x2, player5.y2));
        ...
        //   S.x = 2;
        //   S.y = 30;
        message = "{\"button\":\"boardClick\",\"event\":\"gameEvent\",\"message\":\"p\",\"x\":\"2\",\"y\":\"30\"}";
        S = gson.fromJson(message, ServerEvent.class);
        S.player = player1;
        S.iidd = player1.iD;
        S.victores = Integer.toString(player1.numberOfVictores);
        ...
        //   S.x = 6;
        //   S.y = 34;
        message = "{\"button\":\"boardClick\",\"event\":\"gameEvent\",\"message\":\"e\",\"x\":\"6\",\"y\":\"34\"}";
        S = gson.fromJson(message, ServerEvent.class);
        S.player = player1;
        S.iidd = player1.iD;
        S.victores = Integer.toString(player1.numberOfVictores);
